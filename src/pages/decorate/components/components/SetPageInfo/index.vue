...
<script>
import ComTitle from "@/components/BasicUi/ComTitle" // 函数式组件
import ComGroup from "@/components/BasicUi/ComGroup"
import ComDivider from "@/components/BasicUi/ComDivider" // 分割线
import UpLoadBox from "@/components/BasicUi/UpLoadBox" // 上传图片
